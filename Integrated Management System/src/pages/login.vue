  ...
  <div class="index">
    ...
    <div class="full-height row justify-center">
      <div class="column justify-center" style="width:300px">
        <img src="../assets/sjwszz_login.svg" height="110px" width="150px" alt="心医至成" title="心医至成" style="margin:0 auto"/>
        <div class="login-title">综合管理平台</div>
        <div style="text-align:left">
          ...
          <q-input dark type="text" v-model="form.userid" :float-label="$t('Username')" clearable :error="$t($v.form.userid.$error)" :before="[{icon: 'account_circle'}]" autocomplete="new-password" />
...
import axios from '../utils/axios.js'//第二种封装ajax的方法
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.forms.userid = this.form.userid
      this.forms.password = md5(this.form.password)
      this.loading = true;
       
    // axios.JH_news('/auth/login', this.form)
    ...
    //   });
      this.$store
        .dispatch("LoginByUserName", this.forms)
        .then(() => {   
          if (this.interval) {
